...
function DoodleInput({ icon: Icon, label, type = "text", placeholder, showToggle, showValue, onToggle }) {
  return (
    ...
    >
      ...
      <div className="w-full max-w-md">
        ...
        <div className="relative doodle-card wobble-1 bg-white border-2 border-[#2B2B2A] shadow-[6px_6px_0_#FF6B6B] p-8 md:p-10">
          ...
          <button className="doodle-btn w-full flex items-center justify-center gap-3 bg-white py-3.5 border-2 border-[#2B2B2A] font-doodle font-bold text-xl hover:bg-[#2B2B2A]/5 transition-colors">
