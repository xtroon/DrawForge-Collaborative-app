      ...
      <header className="fixed top-0 w-full z-50 bg-[#FFFDF6]/90 backdrop-blur-sm border-b-2 border-[#2B2B2A]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated ? (
              <Link to="/dashboard" className="doodle-btn text-lg font-bold bg-[#2B2B2A] text-[#FFFDF6] px-5 py-2 border-2 border-[#2B2B2A] shadow-[3px_3px_0_#FF6B6B] hover:shadow-[1px_1px_0_#FF6B6B] hover:translate-x-[2px] hover:translate-y-[2px] transition-all inline-block">
                Go to Dashboard
              </Link>
            ) : (
              <>
